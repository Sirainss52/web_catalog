...
<body>
	<div id="top-bar" class="container">
		...
		<div class="row">
			<div class="span12">
				<div class="row">
					<?php $take = $conn->query("SELECT * FROM produk LEFT JOIN kategori ON produk.id_kategori=kategori.id_kategori WHERE kategori.nama_kategori = 'men' "); ?>
					<?php while ($perproduk = $take->fetch_assoc()) { ?>
						<div class="span3">
							<div class="product-box">
								<span class="sale_tag"></span>
								<p><a href="product_detail.php?id=<?php echo $perproduk['id_produk']; ?>"><img src="/P_WEB_3312211066/web-catalog/Admin/foto_produk/men/<?php echo $perproduk['foto_produk']; ?>" alt=""></a></p>
